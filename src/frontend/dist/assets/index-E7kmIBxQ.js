...
const Factory = createLucideIcon("factory", __iconNode$8);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const MAPS_EMBED = "https://maps.google.com/maps?q=Hamirpur,+Himachal+Pradesh,+India&output=embed";
const products = [
  {
    id: 1,
    title: "TMT BARS",
    brands: "SAIL · Jindal · Jai Bharat · Birla",
    description: "High-strength thermomechanically treated bars for superior load-bearing in residential and commercial structures.",
  ...
  },
  {
    ...
    description: "Premium quality pipes for water supply, structural support, and industrial applications across all project scales.",
  ...
  },
  {
    ...
    description: "Durable, weather-resistant corrugated and trapezoidal sheets for industrial, commercial and residential roofing.",
  ...
  },
  {
    ...
    description: "Precision-cut structural steel profiles for fabrication, construction framing and heavy-duty infrastructure work.",
...
function SectionHeading({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: center ? "text-center" : "", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-heading text-4xl md:text-5xl font-bold text-foreground tracking-wide uppercase", children }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `mt-3 h-1 w-16 bg-gold ${center ? "mx-auto" : ""}` })
  ] });
}
function App() {
  const [menuOpen, setMenuOpen] = reactExports.useState(false);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background text-foreground", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "fixed top-0 left-0 right-0 z-50 bg-steel-950/95 backdrop-blur-sm border-b border-steel-700", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between h-16", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "#top", className: "flex-shrink-0 flex items-center gap-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-heading text-lg md:text-xl font-bold text-gold tracking-widest", children: "BANARSI DASS & SONS" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "hidden md:flex items-center gap-8", children: navLinks.map((link, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            href: link.href,
      ...
      menuOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden bg-steel-900 border-t border-steel-700", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "flex flex-col px-4 py-4 gap-4", children: [
        navLinks.map((link, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            href: link.href,
            "data-ocid": `nav.link.${i + 1}`,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "section",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-steel-950/75" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-5xl mx-auto px-4 sm:px-6 text-center pt-16", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-4 mb-6", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold font-body text-xs tracking-[0.3em] uppercase", children: "Hamirpur · Himachal Pradesh" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px w-12 bg-gold" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-heading text-5xl sm:text-7xl md:text-8xl lg:text-9xl font-bold text-white uppercase tracking-wide leading-none mb-4", children: [
              "BANARSI DASS",
              /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold", children: "& SONS" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-heading text-xl sm:text-2xl md:text-3xl font-medium text-gold tracking-widest uppercase mt-6 mb-3", children: "Wholesale Suppliers of Construction Materials" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-base text-steel-400 italic mb-8 tracking-wide", children: "Strength That Lasts Generations" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm md:text-base text-steel-200 max-w-2xl mx-auto leading-relaxed mb-10", children: "Banarsi Dass & Sons is a trusted supplier of TMT bars, roofing sheets, pipes and structural materials in Himachal Pradesh. We supply high quality construction materials from India's leading brands to contractors, builders and dealers." }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "products", className: "py-24 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeading, { children: "Our Products" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-6 text-steel-400 font-body text-sm tracking-widest uppercase", children: "Quality materials from India's most trusted brands" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-14 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6", children: products.map((product, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "article",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-hidden h-52", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
                src: product.image,
                alt: product.title,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-heading text-2xl font-bold text-white tracking-wide mb-2", children: product.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block text-gold font-body text-xs tracking-widest uppercase mb-4 border border-gold/30 px-3 py-1", children: product.brands }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm text-steel-400 leading-relaxed", children: product.description })
            ] })
          ]
        },
        product.id
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-24 bg-steel-900", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeading, { children: "Why Choose Banarsi Dass & Sons" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-14 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6", children: trustPoints.map((point) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: "flex gap-4 items-start p-6 border border-steel-700 hover:border-gold/50 transition-colors",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0 w-8 h-8 bg-gold flex items-center justify-center mt-0.5", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { size: 16, className: "text-steel-950", strokeWidth: 3 }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-heading text-lg font-semibold text-white tracking-wide mb-1", children: point.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs text-steel-400 leading-relaxed", children: point.desc })
            ] })
          ]
        },
        point.title
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "brands", className: "py-24 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeading, { center: true, children: "Brands We Deal In" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-6 font-body text-sm text-steel-400 text-center", children: "We supply materials from India's most trusted manufacturers." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-14 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4", children: brands.map((brand, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-heading text-lg font-bold text-white group-hover:text-gold transition-colors tracking-wide uppercase", children: brand })
        },
        brand
      )) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-24 bg-steel-800", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeading, { center: true, children: "Serving Construction Needs" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-6 font-body text-sm text-steel-400 text-center", children: "From small residential projects to large-scale infrastructure — we supply it all." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-14 flex flex-wrap justify-center gap-4", children: services.map(({ icon: Icon2, label }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { size: 20, className: "text-gold flex-shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-heading text-base font-semibold text-white tracking-wide uppercase", children: label })
          ]
        },
        label
      )) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "about", className: "py-24 bg-steel-900", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-16 items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeading, { children: "About Us" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-8 font-body text-base text-steel-200 leading-relaxed", children: "Banarsi Dass & Sons is a trusted wholesale supplier of construction materials in Hamirpur. With years of experience, we focus on providing reliable materials and building long term relationships with customers." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 font-body text-base text-steel-200 leading-relaxed", children: "Our goal is to support strong construction through quality materials. We work directly with India's leading manufacturers to ensure every product we supply meets the highest standards of quality and durability." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { size: 16, className: "text-gold flex-shrink-0" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-sm text-steel-400 tracking-wide", children: "Hamirpur, Himachal Pradesh, India" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 grid grid-cols-2 gap-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-l-2 border-gold pl-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-heading text-3xl font-bold text-gold", children: "7+" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-body text-xs text-steel-400 mt-1 uppercase tracking-widest", children: "Brands Stocked" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-l-2 border-gold pl-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-heading text-3xl font-bold text-gold", children: "HP" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-body text-xs text-steel-400 mt-1 uppercase tracking-widest", children: "Himachal Pradesh" })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden lg:flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full max-w-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-0 top-0 bottom-0 w-1 bg-gold" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ml-8 border border-steel-700 p-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-heading text-5xl font-bold text-steel-700 leading-none mb-4", children: "EST." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-heading text-7xl font-bold text-gold leading-none", children: "B.D.S" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 font-body text-xs text-steel-400 uppercase tracking-[0.3em]", children: "Banarsi Dass & Sons" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 font-body text-xs text-steel-400 uppercase tracking-[0.3em]", children: "Hamirpur · H.P." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8 h-px bg-steel-700" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 font-body text-xs text-steel-400 leading-relaxed", children: "A name synonymous with quality, trust and reliability in Himachal Pradesh's construction industry." })
        ] })
      ] }) })
    ] }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "contact", className: "py-24 bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeading, { center: true, children: "Get In Touch" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-6 font-body text-sm text-steel-400 text-center", children: "Reach out for wholesale inquiries, pricing, and availability." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-14 grid grid-cols-1 lg:grid-cols-2 gap-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-heading text-2xl font-bold text-gold tracking-wide uppercase", children: "Banarsi Dass & Sons" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mt-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { size: 14, className: "text-gold flex-shrink-0" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-sm text-steel-200", children: "Hamirpur, Himachal Pradesh, India" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: [PHONE_PRIMARY, PHONE_2, PHONE_3].map((phone) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
              href: `tel:${phone}`,
              className: "flex items-center gap-3 group",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { size: 14, className: "text-gold flex-shrink-0" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-heading text-lg text-white group-hover:text-gold transition-colors tracking-wide", children: [
                  "+91 ",
                  phone.slice(0, 5),
                  " ",
                  phone.slice(5)
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-2 border-gold/40 overflow-hidden h-80 lg:h-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "iframe",
          {
            src: MAPS_EMBED,
            width: "100%",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-[oklch(0.07_0_0)] border-t-2 border-gold", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-heading text-xl font-bold text-gold tracking-widest uppercase mb-4", children: "Banarsi Dass & Sons" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2 mb-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { size: 13, className: "text-gold mt-0.5 flex-shrink-0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-xs text-steel-400 leading-relaxed", children: "Hamirpur, Himachal Pradesh, India" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: [PHONE_PRIMARY, PHONE_2, PHONE_3].map((phone) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
              href: `tel:${phone}`,
              className: "flex items-center gap-2 group",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { size: 11, className: "text-gold flex-shrink-0" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-body text-xs text-steel-400 group-hover:text-gold transition-colors", children: [
                  "+91 ",
                  phone.slice(0, 5),
                  " ",
                  phone.slice(5)
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-heading text-sm font-semibold text-white tracking-[0.2em] uppercase mb-4", children: "Our Products" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2", children: [
            "TMT Bars",
            "Steel Pipes",
            "Roofing Sheets",
            "Structural Steel"
          ].map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-xs text-steel-400", children: item }) }, item)) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-heading text-sm font-semibold text-white tracking-[0.2em] uppercase mb-4", children: "Quick Links" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2", children: [
            { label: "Home", href: "#top" },
            { label: "Products", href: "#products" },
            { label: "About", href: "#about" },
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-12 pt-6 border-t border-steel-700 flex flex-col sm:flex-row items-center justify-between gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-xs text-steel-400 text-center sm:text-left", children: [
          "© ",
          (/* @__PURE__ */ new Date()).getFullYear(),
          " Banarsi Dass & Sons. All rights reserved. | Hamirpur, Himachal Pradesh, India"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
